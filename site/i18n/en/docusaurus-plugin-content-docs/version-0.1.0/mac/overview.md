...
<a class="button button--secondary button--lg margin-right--sm margin-bottom--sm" href="https://github.com/codex-pocket/codex-pocket-releases/releases/tag/mac-v0.1.4">Read the release notes</a>
...
The current public Mac stable is `0.1.4`. In the normal path, download the notarized DMG and start from there. Use the `mac-app` README Quickstart only when you want a source build for development or verification.
