...
description: This page explains how to choose and open a workspace from the iPhone.
---
...
- `Home`
  Best for resuming quickly from recent projects or favorites.
- `Projects`
  Best when you want the full list.
...
- if the `Project` is missing, check [Use It with Codex App](./with-codex-app) or [Register a Project](../mac/register-project)
